import './navbar.css'
import dimensionName from "../assets/dimension.png"
...
const Navbar = (prop) => {
  ...
  const loginstatus = () => {
    ...
    if (token || prop.login) {
      return [
        <>
          <Link to="/"><li className='sign'>Home</li></Link>
          <Link to={"/myfollowingpost"}><li className='sign'>My Following Post</li> </Link>
  ...
  return (
    <div className='navbar'>
      <img id='dimension-logo' src={dimensionName} alt='err' onClick={() => {
        navigate('/')
      }} />
